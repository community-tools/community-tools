...
# CommunityTools.Web.Endpoint.load_from_system_env/1 dynamically.
...
config :community_tools, CommunityTools.Web.Endpoint,
  on_init: {CommunityTools.Web.Endpoint, :load_from_system_env, []},
  url: [host: "localhost"],
  http: [port: 4001],
...
# start per endpoint:
#
#     config :community_tools, CommunityTools.Web.Endpoint, server: true
#
